Ext.define("App.locale", {
    singleton: true,

    data: {
        Common_Field_Name      : "Name",
        Common_Field_Department: "Department",
        Common_Field_Cabinet: "Cabinet",
        Common_Button_Cancel   : "Cancel",
        Common_Button_Submit   : "Submit",
        Common_Button_Apply    : "Застосувати",
        Common_Button_Add      : "Add",
        Common_Button_Edit      : "Edit",

        Confirm_RemoveSelected   : "Remove selected items?",

        //
        Employee_Dialog_Add : "Add Employee",
        Employee_Dialog_Edit : "Edit Employee",
        Employee_Dialog_Remove : "Remove Employee",

        Employee_Field_ShowInSchedule : "Show In Schedule",
    },
    ...
    App.tr = Ext.bind(this.getText, this);
});
